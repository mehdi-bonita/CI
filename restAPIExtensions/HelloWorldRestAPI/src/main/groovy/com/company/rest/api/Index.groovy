...
import com.company.model.VoitureDAO;
import com.company.model.VoitureDAOImpl;
...
class Index implements RestApiController {
    ...
    RestApiResponse doHandle(HttpServletRequest request, RestApiResponseBuilder responseBuilder, RestAPIContext context) {
        ...
        // Retrieve nom parameter
        def nom = request.getParameter "nom"
        if (nom == null) {
            return buildResponse(responseBuilder, HttpServletResponse.SC_BAD_REQUEST,"""{"error" : "the parameter nom is missing"}""")
        }
         ...
         */
        // Prepare the result
        def result = [ "nom" : nom , "message" : "hello " + nom ]

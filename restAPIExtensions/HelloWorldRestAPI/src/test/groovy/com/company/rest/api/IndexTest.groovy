...
class IndexTest extends Specification {
    ...
    def should_return_a_json_representation_as_result() {
        ...
        httpRequest.getParameter("nom") >> "aValue1"
        ...
        jsonResponse.nom == "aValue1"
        jsonResponse.message == "hello " + jsonResponse.nom
    }

    def should_return_an_error_response_if_nom_is_not_set() {
        given: "a request without nom"
        def index = new Index()
        httpRequest.getParameter("nom") >> null
        ...
        jsonResponse.error == "the parameter nom is missing"
    }
